...
const CategorySchema = CollectionSchema(
  ...
  links: {
    r'recipes': LinkSchema(
      id: -3902651137982411570,
      name: r'recipes',
      target: r'Recipe',
      single: false,
...
void _categoryAttach(IsarCollection<dynamic> col, Id id, Category object) {
  object.id = id;
  object.recipes.attach(col, col.isar.collection<Recipe>(), r'recipes', id);
}
...
extension CategoryQueryLinks
    on QueryBuilder<Category, Category, QFilterCondition> {
  QueryBuilder<Category, Category, QAfterFilterCondition> recipes(
      FilterQuery<Recipe> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'recipes');
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> recipesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'recipes', length, true, length, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> recipesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'recipes', 0, true, 0, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> recipesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'recipes', 0, false, 999999, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> recipesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'recipes', 0, true, length, include);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      recipesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'recipes', length, include, 999999, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> recipesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'recipes', lower, includeLower, upper, includeUpper);
    });
  }
}
